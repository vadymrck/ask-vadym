          ...
          {BLOG_POSTS.map((post) => (
            ...
            >
              <div className="flex flex-col sm:flex-row gap-4 p-4">
                <div className="relative w-full sm:w-48 sm:shrink-0 aspect-video rounded-lg overflow-hidden bg-[var(--border)]">
                  {post.thumbnail ? (
                    <Image
                      src={post.thumbnail}
                      alt={post.title}
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-[var(--background)]">
                      <svg className="w-10 h-10 text-[var(--text-secondary)] opacity-40" fill="none" viewBox="0 0 24 24" stroke="currentColor">
